/**
 @Name：项目中心-项目实施
 */
layui.define(['table', 'form', 'common', 'element', 'setter', 'laydate', 'element'], function (exports) {
    var $ = layui.$
        , admin = layui.admin
        , view = layui.view
        , table = layui.table
    ...
    table.on('tool(projects-table)', function (obj) {
        ...
        if (obj.event === 'course') {
            location.hash = '/projectcenter/projectimplement/courses/organization=' + rowdata.organizationId + '/project=' + rowdata.id;
        }
    });

    exports('projectimplement', {})
});