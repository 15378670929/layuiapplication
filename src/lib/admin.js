...
layui.define('view', function (exports) {
    var $ = layui.jquery
        ...
        , APP_BODY = '#IQuizoo_app_body', APP_FLEXIBLE = 'IQuizoo_app_flexible'
        ...
        , admin = {
            ...
            , tabsHeader: function (index) {
                return $('#IQuizoo_app_tabsheader').children('li').eq(index || 0);
            }
    ...
    var events = admin.events = {
        ...
        , note: function (othis) {
            ...
            events.note.index = admin.popup({
                ...
                , shade: 0
                , offset: [
                    '50px', (mobile ? null : (othis.offset().left - 250) + 'px')
                ]
                , anim: -1
                , id: 'LAY_adminNote'
                ...
                , success: function (layero, index) {
                    var textarea = layero.find('textarea')
                        , value = note === undefined ? '爱智游大脑课堂后台管理系统V3.0.0' : note;
        ...
        , rollPage: function (type, index) {
            var tabsHeader = $('#IQuizoo_app_tabsheader')
    ...
    !function () {
        ...
        var path = sessionStorage.getItem("routerpath") == undefined ? [''] : sessionStorage.getItem("routerpath").split(',')
            ...
            , matchMenu = function (list) {
                // sessionStorage.setItem("pathURL", admin.correctRouter(path.join('/')))
                var pathURL = sessionStorage.getItem("pathURL") == undefined ? '/' : sessionStorage.getItem("pathURL");
                list.each(function (index1, item1) {
                    ...
                    listChildren1.each(function (index2, item2) {
                        ...
                        if (matched2) {
                            ...
                            othis2.parent().parent().siblings().find('.'+THIS).removeClass(THIS)
                            othis2.addClass(selected).siblings().removeClass(selected); //标记选择器
                            othis2.parent().parent().addClass(SIDE_NAV_ITEMD).siblings().removeClass(SIDE_NAV_ITEMD)
        ...
        if(sessionStorage.getItem('pathURL')){
          var path = sessionStorage.getItem('pathURL').replace(/\//g,',').slice(1)
          if (path !== sessionStorage.getItem('routerpath')) {
              sessionStorage.setItem('pathURL','/' + sessionStorage.getItem('routerpath').replace(/,/g,'/'))
          }
        }

        //开始捕获
        setTimeout(() => {
            matchMenu($("#LAY-system-side-menu").children("li"));
        }, 500)
    ...
    admin.on('hash(side)', function (router) {
        var path = router.path, 
            ...
            , matchMenu = function (list) {
                ...
                var pathURL = sessionStorage.getItem("pathURL");
                list.each(function (index1, item1) {
                    var othis1 = $(item1)
                        , data1 = getData(othis1)
                        , listChildren1 = data1.list.children('dd')
                    ...
                    listChildren1.each(function (index2, item2) {
                        ...
                        if (matched2) {
                            console.log('222')
                            sessionStorage.setItem("pathURL", admin.correctRouter(path.join('/')))
                            sessionStorage.setItem('routerpath', router.path)
                            var selected = data2.list[0] ? SIDE_NAV_ITEMD : THIS;
                            othis2.addClass(selected).siblings().removeClass(selected); //标记选择器
                            return false
                        }
    ...
    element.on('nav(layadmin-system-side-menu)', function (elem) {
        sessionStorage.setItem("elem", elem)
    ...
    var setThisRouter = function (othis) {
        ...
        , TABS_HEADER = '#IQuizoo_app_tabsheader>li';
