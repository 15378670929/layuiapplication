    ...
    exports('setter', {
        ...
        */
        ...
        , apiAddress: {
            ...
            clientmodules: {
                // list: apiGatewayAddress + "/api/usercenter/SysRoleAuthorize/list",
            ...
            adminuser: {
                list: apiGatewayAddress + '/api/usercenter/SysUser/pagelist',
                add: apiGatewayAddress + "/api/usercenter/SysUser/add",
                update: apiGatewayAddress + "/api/usercenter/SysUser/update",
                updatestate: apiGatewayAddress + "/api/usercenter/SysUser/updatestate",
                delete: apiGatewayAddress + "/api/usercenter/SysUser/delete"
            },
            roles: {
                pagelist: apiGatewayAddress + '/api/usercenter/SysRole/pagelist',
                add: apiGatewayAddress + "/api/usercenter/SysRole/add",
                edit: apiGatewayAddress + "/api/usercenter/SysRole/update",
                updatestate: apiGatewayAddress + "/api/usercenter/SysRole/updatestate",
                delete: apiGatewayAddress + "/api/usercenter/SysRole/delete"
            },
            roleclaims: {
            ...
            rolepermission: {
                ...
                edit: apiGatewayAddress + "/api/usercenter/SysRoleAuthorize/edit",
                getauthorize: apiGatewayAddress + "/api/usercenter/SysRoleAuthorize/getauthorize",
            ...
            SysFunction: {
              ...
              GetSysFunctionByAppID: apiGatewayAddress + '/api/usercenter/SysFunction/GetSysFunctionByAppID',
            }
        }
    });
});