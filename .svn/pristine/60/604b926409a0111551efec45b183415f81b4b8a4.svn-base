...
TreeSelect.prototype.render = function (options) {
    ...
    var a = {
        ...
        input: function () {
            ...
            selectHtml.push('<div class="' + TREE_SELECT_CLASS + ' layui-unselect layui-form-select" id="' + TREE_SELECT_ID + '">');
            selectHtml.push('<div class="' + TREE_SELECT_TITLE_CLASS + '" id="' + TREE_SELECT_TITLE_ID + '">');
            selectHtml.push('<input type="text" id="' + TREE_INPUT_ID + '" placeholder="' + placeholder + '" value="" ' + readonly + ' class="layui-input layui-unselect">');
            selectHtml.push('<i class="layui-edge"></i>');
            selectHtml.push('</div>');
            selectHtml.push('<div class="layui-anim layui-anim-upbit" style="">');
            selectHtml.push('<div class="' + TREE_SELECT_BODY_CLASS + ' ztree" id="' + TREE_SELECT_BODY_ID + '"></div>');
            selectHtml.push('</div>');
            selectHtml.push('</div>');
            $(elem).parent().find("div[class='layui-treeSelect layui-unselect layui-form-select']").remove();
            $(elem).parent().append(selectHtml.join(''));
            return a;
        },
        /**
         * 展开/折叠下拉框
